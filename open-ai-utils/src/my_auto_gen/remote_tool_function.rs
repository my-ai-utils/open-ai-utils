...
pub trait RemoteToolFunctions {
    ...
    async fn tool_call(&self, fn_name: &str, params: &str, ctx: &str) -> Result<String, String>;
}
...
impl RemoteToolFunctionsHandler {
    pub async fn invoke_function(
        ...
        self.data_src.tool_call(func_name, params, ctx).await
    }
}

#[async_trait::async_trait]
impl ToolFunctionAbstract for RemoteToolFunctionsHandler {
    async fn call(&self, func_name: &str, params: &str, ctx: &str) -> Result<String, String> {
        self.data_src.tool_call(func_name, params, ctx).await
    }
}
